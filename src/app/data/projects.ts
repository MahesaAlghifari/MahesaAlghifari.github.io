...
export const projects: Project[] = [
  ...
  // },
  {
    ...
    tags: ["Instagram", "Branding", "Graphics Design", "Canva"],
  ...
  },
  {
    ...
    gallery: [
      ...
      { label: "Instagram Feed", img: Images.greenleaffeeds2, aspect: "1/1" },
      { label: "Instagram Feed", img: Images.greenleaffeeds1, aspect: "1/1" },
      { label: "Instagram Feed", img: Images.greenleaffeeds3, aspect: "1/1" },
    ],
  },
  // {
